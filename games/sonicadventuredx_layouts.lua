...
function layouts.addressTest:init()
  ...
  self:addItem(
    function()
      ...
      table.insert(
        lines,
        "pointerValue (StSpeed addr): "..utils.intToHexStr(
          self.game.pointerValue))
...
-- Speed, position, rotation, time, inputs.
--
-- updatesPerSecond:
